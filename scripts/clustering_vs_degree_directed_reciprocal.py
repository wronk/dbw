...
from random_graph.binary_directed import biophysical_reverse_outdegree_reciprocal as rg
...
for gamma_idx, gamma in enumerate(GAMMAS):
    ...
    G_model_directed = rg(n_nodes, n_edges, gamma, reciprocity=7.)
    G_model = G_model_directed.to_undirected()
    print 'undirected edges %d' % len(G_model.edges())
...
fig, axs = plt.subplots(2, 4, facecolor=FACECOLOR, tight_layout=True, sharex=True)
