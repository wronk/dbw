...
top_out_in_tuples = zip(out_in_labels[:top_out_in],
                        out_in_names[:top_out_in],
                        out_in_vals[:top_out_in])
pp.pprint(top_out_in_tuples)

# Print out bottom-ranked nodes
print 'Bottom nodes by output/input ratio:'
bot_out_in_tuples = zip(out_in_labels[-bot_out_in:],
                        out_in_names[-bot_out_in:],
                        out_in_vals[-bot_out_in:])
...
top_node_btwn_tuples = zip(node_btwn_labels[:top_node_btwn],
                           node_btwn_names[:top_node_btwn],
                           node_btwn_vals[:top_node_btwn])
...
top_degree_tuples = zip(degree_labels[:top_degree],
                        degree_names[:top_degree],
                        degree_vals[:top_degree])
...
top_ccoeff_tuples = zip(ccoeff_labels[:top_ccoeff],
                        ccoeff_names[:top_ccoeff],
                        ccoeff_vals[:top_ccoeff])
