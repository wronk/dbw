...
Plot the in- vs. outdegree distribution for the biophysical revere model.
"""
...
from random_graph.binary_directed import biophysical_reverse as biophysical_model
